...
function Usecase() {
  ...
  return (
    <div className="w-[80%] mx-auto mt-[50px] flex flex-col items-center p-5 rounded-[20px] bg-transparent max-[1200px]:w-full">
        <h2 className="text-center px-5 py-[5px] bg-[#ae00ff2b] text-[rgb(110,99,255)] text-sm font-normal uppercase backdrop-blur-[40px] rounded-full shadow-[0px_0px_10px_1px_rgba(255,255,255,0)] mb-[5px]">Use Cases</h2>
